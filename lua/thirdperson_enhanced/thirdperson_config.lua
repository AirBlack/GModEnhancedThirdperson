if CLIENT then
	...
	hook.Add("PopulateToolMenu", "ThirdpersonSandboxMenu", function()
		spawnmenu.AddToolMenuOption("Utilities", "User", "thirdperson_etp_options", "Thirdperson", "", "", function(panel)
			...
			panel:KeyBinder("Set the Bind-Key", "thirdperson_etp_bind")
			panel:ControlHelp("Not saved in presets")
			...
			panel:CheckBox("Enable Aiming", "thirdperson_etp_aim")
			...
			panel:CheckBox("Smooth Camera Moving", "thirdperson_etp_smoothing")

			panel:NumSlider("Speed Smooth Camera", "thirdperson_etp_smoothing_speed", 0.0, 100.0)

			panel:CheckBox("Use Custom Crosshair", "thirdperson_etp_crosshair")
			...
			panel:CheckBox("Crosshair Outline", "thirdperson_etp_crosshair_outline")
